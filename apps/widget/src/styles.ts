...
.meta { font-size: 12px; color: #8a93a6; margin: 0 2px 4px; }
...
.ai .bubble, .agent .bubble { background: #fff; color: #1a2c4e; border-bottom-left-radius: 4px; }
...
.time { font-size: 12px; color: #aab2c0; margin: 4px 4px 0; }
